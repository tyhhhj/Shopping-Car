...
<html>
  ...
  <body>
	...
	<form action="ShoppingCar_core code.jsp?action=buy&id=<%=0%>" method="post" name="form1">
	...
	<tr height="100" align="center">
	<form action="ShoppingCar_core code.jsp?action=buy&id=<%=1%>" method="post" name="form1">
	...
	<tr height="100" align="center">
	<form action="ShoppingCar_core code.jsp?action=buy&id=<%=2%>" method="post" name="form1">
	...
	<tr height="100" align="center">
	<form action="ShoppingCar_core code.jsp?action=buy&id=<%=3%>" method="post" name="form1">
		...
		<tr height="50">
			<td align="center" colspan="5"><a href="">查看购物车</a></td>
			<%--//to do--%>
		</tr>
	</table>
	</body>
